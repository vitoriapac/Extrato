...
- importação estruturada em JSON e CSV — concluída com prévia detalhada, erros por linha, modelo CSV para download, limites de segurança, mesclagem idempotente e preservação de histórico e ajustes manuais;
