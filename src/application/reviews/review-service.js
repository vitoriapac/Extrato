...
export function createReviewService({repository,clock,idGenerator,findTopic=()=>null,resolveEvidenceScope=()=>null,calculateAdaptiveState,algorithmVersion=()=>1,onEvent=()=>{},onTopicChanged=()=>{}}={}){
