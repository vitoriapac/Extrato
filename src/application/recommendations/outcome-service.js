...
export function captureRecommendationBaseline({mastery=null,accuracy=null,questionVolume=0,retention=null,retentionScore=null,reviewHealth=null,risk=null,trend=null,daysSinceContact=null,measuredAt}={}){
...
export function captureRecommendationSnapshot(recommendation,{baseline=null,createdAt=null}={}){
  ...
  return Object.freeze({recommendationId:recommendation.recommendationId,algorithmVersion:Number(recommendation.algorithmVersion)||1,subjectId:recommendation.subjectId||null,topicId:recommendation.topicId||null,
    ...
    recommendedMinutes:Math.max(0,Number(recommendation.estimatedMinutes)||0),recommendedQuestions:Math.max(0,Number(recommendation.recommendedQuestions)||0),before:structuredClone(before),createdAt:createdAt||recommendation.shownAt||null});
}
