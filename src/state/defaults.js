...
export function createDefaultState(){
  return {
    ...
    algorithmVersions:{...DEFAULT_ALGORITHM_VERSIONS},progressHistory: [], studySessions: [], dailyPlans: [], studyPlans: [], planAdjustments: [], recommendationFeedback: [], weeklyCloseSnapshots:[], alertStates: [],
    activeTimer: {
