const CACHE_NAME='studytrack-3566afae246a';
const APP_SHELL=[
  './','./index.html','./styles/tokens.css','./styles/app.css?v=3566afae246a','./styles/print.css',
  './src/theme-bootstrap.js','./src/app.bundle.js?v=3566afae246a','./src/pwa.js','./manifest.webmanifest',
