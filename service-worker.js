const CACHE_NAME='studytrack-9b7c294d9a19';
const APP_SHELL=[
  './','./index.html','./styles/tokens.css','./styles/app.css?v=9b7c294d9a19','./styles/print.css',
  './src/theme-bootstrap.js','./src/app.bundle.js?v=9b7c294d9a19','./src/pwa.js','./manifest.webmanifest',
