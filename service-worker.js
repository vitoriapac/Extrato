const CACHE_NAME='studytrack-v10';
const APP_SHELL=[
  './','./index.html','./styles/tokens.css','./styles/app.css?v=10','./styles/print.css',
  './src/theme-bootstrap.js','./src/app.bundle.js?v=10','./src/pwa.js','./manifest.webmanifest',
