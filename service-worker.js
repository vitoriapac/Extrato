const CACHE_NAME='studytrack-9e423662669a';
const APP_SHELL=[
  './','./index.html','./styles/tokens.css','./styles/app.css?v=9e423662669a','./styles/print.css',
  './src/theme-bootstrap.js','./src/app.bundle.js?v=9e423662669a','./src/pwa.js','./manifest.webmanifest',
