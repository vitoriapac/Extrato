const CACHE_NAME='studytrack-ef5dba3c3a2e';
const APP_SHELL=[
  './','./index.html','./styles/tokens.css','./styles/app.css?v=ef5dba3c3a2e','./styles/print.css',
  './src/theme-bootstrap.js','./src/app.bundle.js?v=ef5dba3c3a2e','./src/pwa.js','./manifest.webmanifest',
