...
A área **Inteligência da prova** apresenta um resumo da base, sua qualidade, os tópicos de maior impacto, a comparação **Prova × Você** e a auditoria de configuração. Na matriz, alterne entre **Histórico** e **Prioridades**; filtre por concurso, banca, ano, cargo e disciplina, busque um tópico e ordene por incidência, impacto, domínio, lacuna ou disciplina. Ao selecionar um tópico, compare incidência e confiança com domínio, retenção e prioridade pessoal. No celular, a matriz aparece em cards. Provas parciais ficam fora do denominador de incidência.
